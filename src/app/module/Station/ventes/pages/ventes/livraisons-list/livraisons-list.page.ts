...
@Component({
  ...
  standalone: true,
  imports: [ButtonComponent, LivraisonFormDialogComponent, DatePipe, LocaleCurrencyPipe, RecordListCardComponent, TranslatePipe],
...
export class LivraisonsListPage implements OnInit {
  ...
  readonly editingLivraisonValue = computed(() => this.editingLivraison());
