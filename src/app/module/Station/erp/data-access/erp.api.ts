...
const demoStockOverview: StockOverview = {
  sectionTitle: 'Stock',
  items: [
    { id: 1, name: 'Gazoil 10 ppm', unit: 'L', quantityOnHand: 38_200, minThreshold: 10_000, status: 'optimal' },
    { id: 2, name: 'Shampoing', unit: 'L', quantityOnHand: 120, minThreshold: 40, status: 'optimal' },
    { id: 3, name: 'Filtre à huile', unit: 'pcs', quantityOnHand: 62, minThreshold: 15, status: 'alerte' },
    { id: 4, name: 'Cire', unit: 'L', quantityOnHand: 35, minThreshold: 30, status: 'alerte' },
    { id: 5, name: 'Nettoyant jantes', unit: 'L', quantityOnHand: 12, minThreshold: 25, status: 'critique' },
    { id: 6, name: 'Excellium', unit: 'L', quantityOnHand: 8_400, minThreshold: 5_000, status: 'optimal' },
    { id: 7, name: 'Polish', unit: 'u', quantityOnHand: 18, minThreshold: 10, status: 'optimal' },
  ],
};
