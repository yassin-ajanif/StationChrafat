...
const demoDevis: Devis[] = [
  ...
  },
  {
    ...
    serviceLines: [
      {
        id: 3,
        reference: 'SRV-VID-EXP',
        designation: 'Vidange express',
        quantity: 34,
        unit: 'u',
        unitPriceHT: 25,
        discountPercent: 0,
...
const demoCommandes: Commande[] = [
  {
    ...
    description: 'Bon de commande vidange complète',
    serviceLines: [
      {
        id: 1,
        reference: 'SRV-VID-COMP',
  ...
  },
  {
    ...
    serviceLines: [
      {
        id: 3,
        reference: 'SRV-VID-CHS',
        designation: 'Vidange chassis',
        quantity: 10,
        unit: 'u',
        unitPriceHT: 62.5,
        discountPercent: 0,
...
const demoFactures: Facture[] = [
  {
    ...
    serviceLines: [
      {
        id: 1,
        reference: 'SRV-VID-FLOTTE',
        designation: 'Vidange flotte',
        quantity: 400,
        unit: 'u',
        unitPriceHT: 26,
        discountPercent: 0,
  ...
  },
  {
    ...
    serviceLines: [
      {
        id: 2,
        reference: 'SRV-VID-PRO',
        designation: 'Vidange pro',
        quantity: 1_600,
        unit: 'u',
        unitPriceHT: 25.1,
        discountPercent: 0,
    ...
    serviceLines: [
      {
        id: 1,
        reference: 'SRV-AVOIR',
        designation: 'Avoir vidange flotte',
        quantity: 1,
        unit: 'u',
        unitPriceHT: 416.67,
        discountPercent: 0,
...
const demoDevisAchat: DevisAchat[] = [
  {
    ...
    notes: 'Huile et filtres — trimestre',
    serviceLines: [
      {
        id: 1,
        reference: 'SRV-APPRO',
...
const demoReceptions: Reception[] = [
  {
    ...
    description: 'Réception huile moteur',
    montant: 5_400,
    serviceLines: [
      {
        id: 1,
  ...
  },
  {
    ...
    description: 'Réception filtres confirmée',
    montant: 3_360,
    serviceLines: [
      {
        id: 2,
...
const demoStockOverview: StockOverview = {
  ...
  items: [
    { id: 1, name: 'Huile moteur', unit: 'L', quantityOnHand: 120, minThreshold: 40, status: 'optimal' },
    { id: 2, name: 'Filtre à huile', unit: 'u', quantityOnHand: 35, minThreshold: 30, status: 'alerte' },
    { id: 3, name: 'Joint de vidange', unit: 'u', quantityOnHand: 12, minThreshold: 25, status: 'critique' },
    { id: 4, name: 'Dégraissant', unit: 'L', quantityOnHand: 48, minThreshold: 20, status: 'optimal' },
    { id: 5, name: 'Liquide de frein', unit: 'L', quantityOnHand: 18, minThreshold: 10, status: 'optimal' },
  ],
};
